...
import com.soon.android.utils.PoiOverlay;
...
public class PoiSelectActivity extends AppCompatActivity implements
    ...
    public void onGetPoiResult(PoiResult poiResult) {
        if (poiResult == null || poiResult.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(PoiSelectActivity.this, "未找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        ...
        if (poiResult.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
            ...
            strInfo += "找到结果";
            Toast.makeText(PoiSelectActivity.this, strInfo, Toast.LENGTH_LONG)
                    .show();
        }
    ...
    public void onGetPoiDetailResult(PoiDetailResult poiDetailResult) {
        if (poiDetailResult.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(PoiSelectActivity.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
                    .show();
        } else {
    ...
    public void onGetSuggestionResult(SuggestionResult suggestionResult) {
        ...
        sugAdapter = new ArrayAdapter<String>(PoiSelectActivity.this, android.R.layout.simple_dropdown_item_1line, suggest);
        searchText.setAdapter(sugAdapter);
